...
public class Search {
	...
	public void i_search_for_a_product(String product) {
		...
		Elements.click(HeaderSection.Button);
	}

	@Then("^I should see the product in the search results$")
	public void i_should_see_the_product_in_the_search_results()  {
		Assert.assertTrue(Elements.isDisplayed(SearchResultPage.SamsungSyncMasterProduct));
	...
	public void i_should_see_a_message_informing(String message)  {
		Assert.assertTrue(Elements.VerifyTextEquals(SearchResultPage.ProductNotMacth_msg, "There is no product that matches the search criteria."));
	}
}
